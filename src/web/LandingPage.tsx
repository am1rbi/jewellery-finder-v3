...
const LandingPage: React.FC = () => {
  ...
  const slides = [
    {
      background: {
        backgroundColor: 'hsla(1,0%,7%,1)',
        backgroundImage: `
          radial-gradient(at 36% 6%, hsla(103,85%,15%,0.65) 0px, transparent 50%),
          radial-gradient(at 83% 0%, hsla(51,100%,50%,0.57) 0px, transparent 50%),
          radial-gradient(at 0% 50%, hsla(355,0%,0%,1) 0px, transparent 50%),
          radial-gradient(at 61% 27%, hsla(340,0%,0%,1) 0px, transparent 50%),
          radial-gradient(at 0% 100%, hsla(43,74%,49%,1) 0px, transparent 50%)
        `
      },
      textColor: 'white',
    ...
    },
    {
      ...
      textColor: '#2a2a2a',
      title: 'יש לך תמונה של התכשיט המושלם?',
      content: 'Gold & Gem כאן כדי לחסוך לך זמן וכאב ראש. שתף איתנו תמונות של התכשיט שהיא בחרה, ותן לאפליקציה מבוססת ה AI שלנו למצוא לך אותו ברבע מהזמן שלוקח לך להגיע לבורסה ברמת גן.',
      buttonColor: '#2a2a2a',
      frameColor: '#2a2a2a',
    },
